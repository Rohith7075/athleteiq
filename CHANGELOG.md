...
- Replaced Gemini SDK fetch with direct HTTPS calls (fixes Windows fetch issues)

## [1.0.1] — 2026-06-12

### Added
- Comprehensive DEPLOYMENT.md guide with 4 deployment options
- Docker standalone output mode in next.config.js

### Fixed
- Root package.json merge conflict that broke Vercel deployments
- Gemini API "fetch failed" error by replacing undici fetch with Node.js https module